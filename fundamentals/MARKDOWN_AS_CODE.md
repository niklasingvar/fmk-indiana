...
- The industry name is [docs-as-code](https://www.writethedocs.org/guide/docs-as-code/): docs live in git and pass the same review and CI gates as code.
- Established toolchain: markdownlint for structure, Vale for prose style, lychee for links — merge-blocking in CI, incremental on changed files only.
